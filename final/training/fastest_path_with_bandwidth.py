...
def plot_final_graph(min_epochs, min_costs, start_state, end_state, epoch):
    ...
    plt.title('Minimum Time vs Epoch (With Bandwidth)')
    plt.savefig(f"epoch_vs_cost_plots/fastest_path_with_bandwidth_{start_state}_{end_state}_{epoch}.png")
...
if __name__ == '__main__':
    ...
    num_epoch = 20000
    user_id = 1455
    total_data_to_be_transfer = 20   # In Bits
